...
function mb_register_subfolder_for_stack( $stack ){
...
add_filter( 'eventorganiser_template_stack', 'mb_register_subfolder_for_stack' );
 ...
 */
function mb_eventorganiser_templates( $template ){
...
add_filter('template_include', 'mb_eventorganiser_templates', 5 );

/**
 * Assign appropriate default classes to booking form button
 */
function mb_booking_button_classes( $class, $form ){
...
add_filter( 'eventorganiser_booking_button_classes', 'mb_booking_button_classes', 10, 2 );


/**
 * Assign appropriate default classes to error/warning notices
 */
function mb_booking_error_classes( $class, $form ){
...
add_filter( 'eventorganiser_booking_error_classes', 'mb_booking_error_classes', 10, 2 );


/**
 * Assign appropriate default classes to notices
 */
function mb_booking_notice_classes( $class, $form ){
...
add_filter( 'eventorganiser_booking_notice_classes', 'mb_booking_notice_classes', 10, 2 );